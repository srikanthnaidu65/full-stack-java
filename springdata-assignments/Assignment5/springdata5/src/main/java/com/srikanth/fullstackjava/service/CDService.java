...
public class CDService {
	...
	@Transactional
	public List<CD> findByCdPrice(Double price) {
		return repository.findByCdPrice(price);
	}

	@Transactional
	public int countByCdprice(Double price) {
		return repository.countByCdPrice(price);
	}
